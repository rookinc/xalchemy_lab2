...
export async function orderFromGraph(cluster) {
  ...
  return {
    ...
    neighborhood: cluster.debug.neighborhood || { ring1: [], ring2: [], ring1Count: 0, ring2Count: 0 },
    shellDebug: cluster.debug.shellDebug,
...
export async function readoutFromGraph(order) {
  ...
  return {
    ...
    neighborhood: order.neighborhood || { ring1: [], ring2: [], ring1Count: 0, ring2Count: 0 },
    shellBase: order.shellBase || [],
    quotientShell: order.quotientShell || [],
    ...
    shellSource: order.shellSource || null,
    diadSource: order.diadSource || null,
    orderingSource: order.orderingSource || null,
    shellRing2Degrees: order.shellRing2Degrees || [],
    boundaryVariance: order.boundaryVariance ?? null,
    boundaryUniformityScore: order.boundaryUniformityScore ?? null,
    matchingScore: order.matchingScore ?? null,
    transportScore: order.transportScore ?? null,
    transportDebug: order.transportDebug ?? null,
    ...
    isCanonicalLocalMachine: Boolean(order.isCanonicalLocalMachine)
  };
}
