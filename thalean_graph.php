...
<main class="app proof-app">
  <section id="overview" class="panel intro-hero">
    <div class="panel-inner intro-stack">
      <div class="card intro-card">
        <h1>The Thalean Graph AT4val[60,6]</h1>
        <p class="muted">
          This page presents a finite witness built from a local transport rule on the flag
          structure of the combinatorial dodecahedron. The construction produces a quotient tower
          G60 → G30 → G15 with G15 ≅ L(Petersen), together with a 15 × 30 sector-edge incidence
          matrix M satisfying the exact quadratic law
          Q = MMᵀ = A³ + 2A² + 2I.
        </p>
        <p class="muted">
          Two theorem-facing results anchor this surface. The March 2026 paper establishes the
          quotient-core construction and proves the quadratic identity. The April 2026 paper shows
          that the same matrix M carries a rigid internal chamber grammar with canonical block and
          row classes. Together they show that the witness is algebraic, combinatorial, and
          inspectably finite.
        </p>
        <p class="muted">
          A companion witness note gathers the finite object into a single unified theorem-facing
          surface. A separate CMB methods note explores a structural benchmark program using mixed
          family comparisons inspired by this broader template reservoir. This page gathers those
          public theorem-facing artifacts into one audit surface.
        </p>
      </div>

      <div class="section-head">
        <p class="eyebrow">Companion papers</p>
        <h2>Read the papers</h2>
        <p class="muted">
          Each paper plays a distinct role in the public theorem surface: core construction,
          internal grammar, unified witness presentation, and exploratory benchmark methods.
        </p>
      </div>

      <div class="paper-card-grid">
        <article class="card paper-card">
          <p class="paper-kicker">March 2026 preprint</p>
          <h3>Dodecahedral Transport</h3>
          <p class="muted paper-subtitle">
            <em>Dodecahedral Transport, Sector Geometry on L(Petersen), and the Identity MMᵀ = A³ + 2A² + 2I</em>
          </p>
          <p class="muted">
            Establishes the quotient-core construction and proves the exact quadratic identity
            Q = MMᵀ = A³ + 2A² + 2I.
          </p>
          <div class="paper-meta">
            <div><strong>DOI:</strong> 10.5281/zenodo.19043356</div>
            <div><strong>Role:</strong> Quotient-core theorem</div>
          </div>
        ...
        <article class="card paper-card">
          <p class="paper-kicker">April 2026 preprint</p>
          <h3>Chamber Grammar</h3>
          <p class="muted paper-subtitle">
            <em>The Chamber Grammar of the Thalean Sector Matrix</em>
          </p>
          <p class="muted">
            Shows that the same witness matrix M carries a rigid chamber grammar with canonical
            block classes, row classes, and hinge-governed internal organization.
          </p>
          <div class="paper-meta">
            <div><strong>DOI:</strong> 10.5281/zenodo.19520206</div>
            <div><strong>Role:</strong> Internal structure of M</div>
          </div>
        ...
        <article class="card paper-card">
          ...
          <p class="muted paper-subtitle">
            <em>Thalean Witness</em>
          </p>
          <p class="muted">
            Presents the unified finite witness surface, gathering the main theorem-facing object
            into a single public note centered on the finite audit structure itself.
          </p>
          <div class="paper-meta">
            <div><strong>DOI:</strong> 10.5281/zenodo.19542052</div>
            <div><strong>Role:</strong> Unified witness note</div>
          </div>
        ...
        <article class="card paper-card">
          <p class="paper-kicker">April 2026 preprint</p>
          <h3>CMB Structured Benchmark</h3>
          <p class="muted paper-subtitle">
            <em>A Mixed Structured Template for a TE-Dominated Middle-Band CMB Benchmark</em>
          </p>
          <p class="muted">
            An exploratory methods/result note. It does not prove the theorem, but studies whether
            a benchmarked CMB pattern is structurally selective with respect to related family classes.
          </p>
          <div class="paper-meta">
            <div><strong>DOI:</strong> 10.5281/zenodo.19561286</div>
            <div><strong>Role:</strong> Exploratory benchmark methods</div>
          </div>
